...
public class LightFeatures extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int sensor_index = Integer.parseInt(intent.getStringExtra(LightSensors.EXTRA_MESSAGE));
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        Intent intent = getIntent();
        int sensor_number = (Integer.parseInt(intent.getStringExtra(LightSensors.EXTRA_MESSAGE)) + 1);
