...
public class EnvironmentDisplaySavedValue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_environment_display_saved_value);
        ...
        if ( !file.exists() ) {
            tv = findViewById(R.id.environmentdisplaysavedvalue);
