...
public class ProximitySensors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_proximity_sensors);
        ...
        if (sensormanager.getDefaultSensor(Sensor.TYPE_PROXIMITY) != null) {
            ...
            View.OnClickListener[] listeners = new View.OnClickListener[ProximityList.size()];
            final Context context = this;
            for (int q = 0; q < ProximityList.size(); q++) {
                final int temp = q;
                listeners[q] = new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(context, ProximityFeatures.class);
