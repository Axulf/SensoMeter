...
public class MagneticFieldFeatures extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int sensor_index = Integer.parseInt(intent.getStringExtra(MagneticFieldSensors.EXTRA_MESSAGE));
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        Intent intent = getIntent();
        int sensor_number = (Integer.parseInt(intent.getStringExtra(MagneticFieldSensors.EXTRA_MESSAGE)) + 1);
